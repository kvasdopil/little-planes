...
export const CITIES: CityData[] = [
  ...
  { id: 'bergen', position: new Vector3(0.82, 0.6, 0), name: 'Bergen', size: 'small' },
  { id: 'helsinki', position: new Vector3(5.0, 0.34, 0), name: 'Helsinki', size: 'small' },
  { id: 'tampere', position: new Vector3(4.75, 1.9, 0), name: 'Tampere', size: 'small' },
  { id: 'reykjavik', position: new Vector3(-5.0, 5.0, 0), name: 'Reykjavik', size: 'small' },
  { id: 'trondheim', position: new Vector3(1.9, 4.15, 0), name: 'Trondheim', size: 'small' },
];
